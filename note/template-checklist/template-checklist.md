...
**Cập nhật:** 2026-06-27 (bổ sung từ bài PharmaDist: **Bước 0 quét ràng buộc** chống dắt mũi · **Bước 2.5 Tích hợp** · **Bước 4.5 Xây nhãn + censoring** · **Bước 5 chọn time-split vs random** · structural missing · importance bằng hệ số khi cấm cây) · trước đó 2026-06-21 (scale theo ĐỘ LỚN · 4 nỗi sợ leakage · ensemble · chính quy hóa ≠ chuẩn hóa) · **Liên quan:** [[xu-ly-du-lieu]] · [[eda-checklist]] · [[SECOND_BRAIN]]
